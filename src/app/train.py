...
parser.add_argument('--learner_device', type=str, default=None, help='Device for the learner (default: cuda)')
...
parser.add_argument('--learn_iter', type=int, default=1000, help='Learn frequency for the distributed workers (default: 1000)')
parser.add_argument('--sync_iter', type=int, default=100, help='Sync interval for the distributed workers (default: 100)')
